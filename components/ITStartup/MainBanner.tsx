						...
						<div className="row h-100 justify-content-center align-items-center">
							<div className="col-lg-5">
								<div className="hero-content">
									...
									<p>
										We offer complete one stop solution for your business setup
										in the UAE. We take pride in recommending the quickest and
										cheapest license options in Dubai Mainland with complete
										cost transparency. Clients pay all government costs directly
										at the counters.
									</p>
